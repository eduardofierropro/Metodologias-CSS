...
Aquí tienes los ejemplos de las dos metodologías que he usado en Youtube para explicar las bases de las metodologías tanto de BEM como de SUITCSS.
En ambos casos encontrarás varios archivos.

* Archivo `index.html` con el código base para comparar
* Archivo `app.css`  con el código adaptado para CSS
* Archivo `app.scss` aplicando técnicas de anidación en SASS
